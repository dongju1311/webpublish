//DOM 트리 생성(body 실행) DOMContentLoaded 함수 처리 
...
async function createSwiper() {
    ...
    <!-- Additional required wrapper -->
        <div class="swiper-wrapper">
            <!-- Slides -->
            ${posterList.map((posterUrl)=>{return `
                <div class="swiper-slide">
                    <img class="swiper-img" src="${posterUrl}" alt="">
                </div>    
            `}).join("")}
            <div class="swiper-slide">
                <img class="swiper-img" src="/webpublish/image/img3.jpg" alt="">
            </div>
            <div class="swiper-slide">
                <img class="swiper-img" src="/webpublish/image/img5.jpg" alt="">
            </div>
        </div>
