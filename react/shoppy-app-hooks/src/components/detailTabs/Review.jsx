 ...
 */
export function ReveiwType({title,names,values}) {
    return(
...
export function ReviewListItem() {
    return(
        <div className='review-list-item'>
            ...
            <div className='pdt_review_datail'>
                <p className='pdt_review_text'>
                    사진보다 색이 연해서 더 맘에 드네요 옷은 무겁습니다.
                </p>
            </div>
